      ...
      <div className="bg-white shadow-md rounded-xl border border-base-300 overflow-hidden">
        ...
        <div className="px-6 pb-6 relative">
          ...
          <div className="space-y-4 font-hind">
            <div>
              <h1 className="text-2xl font-bold font-montserrat">{displayName || 'User'}</h1>
              ...
              <InfoCard 
                ...
                items={[
                  ...
                  { label: "Email Verification", 
                    value: emailVerified ? 
                      <span className="badge badge-success text-white">Verified</span> : 
                      <span className="badge badge-warning text-white">Unverified</span> 
                  }
                ]}
              />
              ...
              <InfoCard 
                ...
                items={[
                  { 
                    ...
                    value: <button className="btn btn-sm btn-primary">Edit</button>
                  },
                  { 
                    label: "Change Password", 
                    value: <button className="btn btn-sm btn-outline">Reset</button>
                  }
                ]}
              />
            </div>
